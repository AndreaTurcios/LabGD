...
<body>
    ...
    <a  href="https://wa.me/50322614705?text=Hola%me@%20encuentro%20interesado%20en%20contactar%20por%20un%20servicio" class="wa" id="btnCarrito">
                    ...
                    while ($data = mysqli_fetch_assoc($query)) { ?>
                        <div class="col mb-5 productos" category="<?php echo $data['categoria']; ?>">
                            <div class="card h-100">
                                ...
                                <!-- Product actions-->
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent d-flex justify-content-center" a  href="https://wa.me/50322614705?text=Estoy%20interesad@%20en%20este%20producto:%20<?php echo $data['nombre'] ?>+ "">
                                    <a class="wp" href="https://wa.me/50322614705?text=Estoy%20interesad@%20en%20este%20producto:%20<?php echo $data['nombre'] ?>+ "">
    ...
    <div class="backtoup">
        <a href="#" class="btn btn-light btn-lg" role="button" aria-disabled="true">↑</a>
    </div>
			...
			<div class="row full-height justify-content-center">
				<div class="col-12 text-center align-self-center py-5">
					<div class="section text-center py-5 py-md-0">
			          	...
			          	<label for="pricing"><span class="block-diff"> Mantenimien <span class="float-right">Reparac</span></span></label>
                    ...
                    <div class="col-xl-4 col-lg-4 mb-50">
                        <div class="footer-widget">
                            <div class="footer-logo">
                                <a href="https://andreaaturcios.com"><img src="https://andreaaturcios.com/img/LogoSinFondo.png" class="img-fluid" alt="logo"></a>
                            </div>
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="subscribe-form">
                                <form action="https://formsubmit.co/programmer@andreaaturcios.com" method="POST">
                                    ...
                                    <input type="hidden" name="sitio" placeholder="laptopsgyd.com" value="laptopsgyd.com" required>
                                        <button type="submit">
                                        <p>Send</p>
                                        </button>
                                </form>
