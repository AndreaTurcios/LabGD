...
<body>
    ...
    <header class="contCard">
        ...
        <div class="conteiner separador bg-dark">
        </div>
        <div class="conteiner separador_texto ">
            
            <h2>Laptops G&D</h2>
            <hr><br>
            <h4 id="guia">Somos una empresa con más de 22 años de experiencia. Contamos con centro de venta de Repuestos y accesorios para laptop.</h4>
        </div>      
    </header>
    
    <div class="container-fluid text-center py-5 px-5 mensajes">
